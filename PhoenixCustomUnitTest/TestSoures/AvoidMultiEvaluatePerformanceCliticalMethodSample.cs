...
namespace PhoenixCustomUnitTest
{
	...
	{
		// 1回だけ評価するのはOK
		[TestInfo(TargetRuleName = nameof(AvoidMultiEvaluatePerformanceCliticalMethod), ViolationCount = 0)]
		...
		// 2回評価するのはNG
		[TestInfo(TargetRuleName = nameof(AvoidMultiEvaluatePerformanceCliticalMethod), ViolationCount = 1)]
